...
class WalletNavService
{
     ...
     * @var string
     */
    public $virtualClassName = 'WalletNav';
    public $rawRequest;
    public $Form;
    public $contentType;
    public $headers;
    ...
    public function __construct($request, $response, $args )
    {
        ...
        // legacy
        $this->request = $args;
        $this->Form = new WalletNavFormWrapper($request, $args);
    }
        ...
        switch($this->request['a']){
            ...
            case 'view':
                if ($this->request['a'] === 'edit' && empty($this->request['ui'])) {
                    ...
                    $this->content['onReadyJs'] .= "if(window.gcScreens){history.replaceState({gcEdit:null},'',_SITE_URL+'WalletNav/');gcScreens.openEdit('WalletNav'," . $gcEditPk . ");}";
                } else {
    ...
    */
    public function getApiResponse()
    {
        ...
        $Api = new Api('WalletNav', $this, ['Mode', 'EquityQuote', 'BudgetQuote', 'RefSymbol', 'RefPrice', 'Unpriced']);
    ...
    public function deleteOne()
    {
        ...
        $obj = $_SESSION[_AUTH_VAR]->loadPkScoped(WalletNavQuery::class, json_decode($this->request['i']), 'WalletNav', 'd');
        if ($obj) {
    ...
    protected function gcDeleteRow($obj, &$error, &$messages)
    {
        ...
        try {
            ...
            error_log('WalletNav delete refused by a foreign key: ' . $gcDelMsg);
    ...
    public function saveUpdate(): array
    {
        ...
        $data['i'] = ( $data['IdWalletNav'] ) ? $data['IdWalletNav'] : $this->request['i'];
        ...
        if(!empty($data['i'])) {
            ...
            $e = $this->Form->setUpdateDefaultsWalletNav($data);
            if ($e === null) {
            ...
            $e = $this->Form->setCreateDefaultsWalletNav($data);
