...
/**
 * Base class that represents a row from the 'sim_wallet' table.
 *
 * Paper Wallet
 *
 * @package    propel.generator..om
 */
abstract class BaseSimWallet extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'App\\SimWalletPeer';
    ...
    /**
     * The value for the id_sim_wallet field.
     * @var        int
     */
    protected $id_sim_wallet;

    /**
     * The value for the asset field.
     * @var        string
     */
    protected $asset;
    ...
    /**
     * Initializes internal state of BaseSimWallet object.
     * @see        applyDefaults()
     */
    ...
    /**
     * @Field()
     * Get the [id_sim_wallet] column value.
     *
     * @return int
     */
    public function getIdSimWallet()
    {

        return $this->id_sim_wallet;
    }

    /**
     * @Field()
     * Get the [asset] column value.
     * Asset
     * @return string
     */
    ...
    /**
     * Set the value of [id_sim_wallet] column.
     *
     * @param  int $v new value
     * @return SimWallet The current object (for fluent API support)
     */
    public function setIdSimWallet($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_sim_wallet !== $v) {
            $this->id_sim_wallet = $v;
            $this->modifiedColumns[] = SimWalletPeer::ID_SIM_WALLET;
        }
    ...
    /**
     * Set the value of [asset] column.
     * Asset
     * @param  string $v new value
     * @return SimWallet The current object (for fluent API support)
     */
    public function setAsset($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->asset !== $v) {
            $this->asset = $v;
            $this->modifiedColumns[] = SimWalletPeer::ASSET;
        }
    ...
    public function setQty($v)
    {
        ...
        if ($this->qty !== $v) {
            $this->qty = $v;
            $this->modifiedColumns[] = SimWalletPeer::QTY;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SimWalletPeer::DATE_CREATION;
            }
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SimWalletPeer::DATE_MODIFICATION;
            }
        } // if either are not null
    ...
    public function setIdGroupCreation($v)
    {
        ...
        if ($this->id_group_creation !== $v) {
            ...
            $this->modifiedColumns[] = SimWalletPeer::ID_GROUP_CREATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = SimWalletPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = SimWalletPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_sim_wallet = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->asset = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->qty = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 8; // 8 = SimWalletPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SimWallet object", $e);
        }
    }
    ...
    public function reload($deep = false, ?PropelPDO $con = null)
    {
        ...
        $stmt = SimWalletPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(?PropelPDO $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getConnection(SimWalletPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
        }

        $con->beginTransaction();
        try {
            $deleteQuery = SimWalletQuery::create()
    ...
    public function save(?PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                SimWalletPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = SimWalletPeer::ID_SIM_WALLET;
        if (null !== $this->id_sim_wallet) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SimWalletPeer::ID_SIM_WALLET . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(SimWalletPeer::ID_SIM_WALLET)) {
            $modifiedColumns[':p' . $index++]  = '`id_sim_wallet`';
        }
        if ($this->isColumnModified(SimWalletPeer::ASSET)) {
            $modifiedColumns[':p' . $index++]  = '`asset`';
        }
        if ($this->isColumnModified(SimWalletPeer::QTY)) {
            $modifiedColumns[':p' . $index++]  = '`qty`';
        }
        if ($this->isColumnModified(SimWalletPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(SimWalletPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(SimWalletPeer::ID_GROUP_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_group_creation`';
        }
        if ($this->isColumnModified(SimWalletPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(SimWalletPeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `sim_wallet` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_sim_wallet`':
                        $stmt->bindValue($identifier, $this->id_sim_wallet, PDO::PARAM_INT);
                        break;
                    case '`asset`':
                        $stmt->bindValue($identifier, $this->asset, PDO::PARAM_STR);
                        break;
                    case '`qty`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SimWalletPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SimWalletPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SimWallet'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SimWallet'][$this->getPrimaryKey()] = true;
        $keys = SimWalletPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdSimWallet(),
            $keys[1] => $this->getAsset(),
            $keys[2] => $this->getQty(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdSimWallet($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setAsset($arr[$keys[1]]);
    ...
    {
        $criteria = new Criteria(SimWalletPeer::DATABASE_NAME);

        if ($this->isColumnModified(SimWalletPeer::ID_SIM_WALLET)) $criteria->add(SimWalletPeer::ID_SIM_WALLET, $this->id_sim_wallet);
        if ($this->isColumnModified(SimWalletPeer::ASSET)) $criteria->add(SimWalletPeer::ASSET, $this->asset);
        if ($this->isColumnModified(SimWalletPeer::QTY)) $criteria->add(SimWalletPeer::QTY, $this->qty);
        if ($this->isColumnModified(SimWalletPeer::DATE_CREATION)) $criteria->add(SimWalletPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(SimWalletPeer::DATE_MODIFICATION)) $criteria->add(SimWalletPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(SimWalletPeer::ID_GROUP_CREATION)) $criteria->add(SimWalletPeer::ID_GROUP_CREATION, $this->id_group_creation);
        if ($this->isColumnModified(SimWalletPeer::ID_CREATION)) $criteria->add(SimWalletPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(SimWalletPeer::ID_MODIFICATION)) $criteria->add(SimWalletPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(SimWalletPeer::DATABASE_NAME);
        $criteria->add(SimWalletPeer::ID_SIM_WALLET, $this->id_sim_wallet);
    ...
    {
        return $this->getIdSimWallet();
    }

    /**
     * Generic method to set the primary key (id_sim_wallet column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdSimWallet();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of SimWallet (or compatible) type.
    ...
    {
        $copyObj->setAsset($this->getAsset());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdSimWallet(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SimWallet Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SimWalletPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SimWalletPeer();
        }
    ...
    public function getAuthyGroup(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyGroup === null && ($this->id_group_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAuthyGroup->addSimWallets($this);
             */
        }
    ...
    public function setAuthyRelatedByIdCreation(?Authy $v = null)
    {
        ...
        if ($v !== null) {
            $v->addSimWalletRelatedByIdCreation($this);
        }
    ...
    public function getAuthyRelatedByIdCreation(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdCreation === null && ($this->id_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdCreation->addSimWalletsRelatedByIdCreation($this);
             */
        }
    ...
    public function setAuthyRelatedByIdModification(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addSimWalletRelatedByIdModification($this);
        }
    ...
    public function getAuthyRelatedByIdModification(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdModification === null && ($this->id_modification !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdModification->addSimWalletsRelatedByIdModification($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SimWalletPeer::DEFAULT_STRING_FORMAT);
    }
