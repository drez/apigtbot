            ...
            .div(
                ...
                .div(
                    ...
                    .div(
                        ...
                        ,''," class='sheet-head' ")
                        .div("".$gcSortSheetClear . button(_("Symbol"), " type='button' th='sorted' c='Symbol' class='va-mob-sortrow' ") . button(_("Timeframe"), " type='button' th='sorted' c='Tf' class='va-mob-sortrow' ") . button(_("Price"), " type='button' th='sorted' c='Price' class='va-mob-sortrow' ") . button(_("EMA20"), " type='button' th='sorted' c='Ema20' class='va-mob-sortrow' ") . button(_("EMA50"), " type='button' th='sorted' c='Ema50' class='va-mob-sortrow' ") . button(_("EMA200"), " type='button' th='sorted' c='Ema200' class='va-mob-sortrow' ") . button(_("RSI14"), " type='button' th='sorted' c='Rsi14' class='va-mob-sortrow' ") . button(_("ATR14"), " type='button' th='sorted' c='Atr14' class='va-mob-sortrow' ") . button(_("ATR %"), " type='button' th='sorted' c='AtrPct' class='va-mob-sortrow' ") . button(_("Trend"), " type='button' th='sorted' c='Trend' class='va-mob-sortrow' ") . button(_("Swing high"), " type='button' th='sorted' c='SwingHigh' class='va-mob-sortrow' ") . button(_("Swing low"), " type='button' th='sorted' c='SwingLow' class='va-mob-sortrow' ") . button(_("Candles"), " type='button' th='sorted' c='CandlesUsed' class='va-mob-sortrow' ") . button(_("Funding rate"), " type='button' th='sorted' c='FundingRate' class='va-mob-sortrow' ") . button(_("Depth imbalance"), " type='button' th='sorted' c='DepthImbalance' class='va-mob-sortrow' ") . button(_("Depth imbalance (smoothed)"), " type='button' th='sorted' c='DepthImbalanceAvg' class='va-mob-sortrow' ") . button(_("ADX14"), " type='button' th='sorted' c='Adx14' class='va-mob-sortrow' ") . button(_("ATR% percentile"), " type='button' th='sorted' c='AtrPctRank' class='va-mob-sortrow' ") . button(_("Taker buy ratio"), " type='button' th='sorted' c='TakerBuyRatio' class='va-mob-sortrow' ") . button(_("Volume z-score"), " type='button' th='sorted' c='VolZscore' class='va-mob-sortrow' ") . button(_("Computed at"), " type='button' th='sorted' c='ComputedAt' class='va-mob-sortrow' "), '', " class='sheet-body va-mob-sortsheet-body' ")
