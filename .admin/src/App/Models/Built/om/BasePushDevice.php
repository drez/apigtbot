...
/**
 * Base class that represents a row from the 'push_device' table.
 *
 * Push device
 *
 * @package    propel.generator..om
 */
abstract class BasePushDevice extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'App\\PushDevicePeer';
    ...
    /**
     * The value for the id_push_device field.
     * @var        int
     */
    protected $id_push_device;
    ...
    /**
     * Initializes internal state of BasePushDevice object.
     * @see        applyDefaults()
     */
    ...
    /**
     * @Field()
     * Get the [id_push_device] column value.
     *
     * @return int
     */
    public function getIdPushDevice()
    {

        return $this->id_push_device;
    }
    ...
    public function getPlatform()
    {
        ...
        $valueSet = PushDevicePeer::getValueSet(PushDevicePeer::PLATFORM);
        if (!isset($valueSet[$this->platform])) {
            throw new PropelException('Unknown stored enum key: ' . $this->platform);
        }

        return $valueSet[$this->platform];
    }
    ...
    /**
     * Set the value of [id_push_device] column.
     *
     * @param  int $v new value
     * @return PushDevice The current object (for fluent API support)
     */
    public function setIdPushDevice($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_push_device !== $v) {
            $this->id_push_device = $v;
            $this->modifiedColumns[] = PushDevicePeer::ID_PUSH_DEVICE;
        }
    ...
    public function setIdAuthy($v)
    {
        ...
        if ($this->id_authy !== $v) {
            $this->id_authy = $v;
            $this->modifiedColumns[] = PushDevicePeer::ID_AUTHY;
        }
    ...
    public function setToken($v)
    {
        ...
        if ($this->token !== $v) {
            $this->token = $v;
            $this->modifiedColumns[] = PushDevicePeer::TOKEN;
        }
    ...
    public function setPlatform($v)
    {
        ...
        if ($this->platform !== $v) {
            $this->platform = $v;
            $this->modifiedColumns[] = PushDevicePeer::PLATFORM;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PushDevicePeer::DATE_CREATION;
            }
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PushDevicePeer::DATE_MODIFICATION;
            }
        } // if either are not null
    ...
    public function setIdGroupCreation($v)
    {
        ...
        if ($this->id_group_creation !== $v) {
            ...
            $this->modifiedColumns[] = PushDevicePeer::ID_GROUP_CREATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = PushDevicePeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = PushDevicePeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_push_device = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->id_authy = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->token = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->platform = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            return $startcol + 9; // 9 = PushDevicePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PushDevice object", $e);
        }
    }
    ...
    public function reload($deep = false, ?PropelPDO $con = null)
    {
        ...
        $stmt = PushDevicePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(?PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PushDeviceQuery::create()
    ...
    public function save(?PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                PushDevicePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = PushDevicePeer::ID_PUSH_DEVICE;
        if (null !== $this->id_push_device) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PushDevicePeer::ID_PUSH_DEVICE . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(PushDevicePeer::ID_PUSH_DEVICE)) {
            $modifiedColumns[':p' . $index++]  = '`id_push_device`';
        }
        if ($this->isColumnModified(PushDevicePeer::ID_AUTHY)) {
            $modifiedColumns[':p' . $index++]  = '`id_authy`';
        }
        if ($this->isColumnModified(PushDevicePeer::TOKEN)) {
            $modifiedColumns[':p' . $index++]  = '`token`';
        }
        if ($this->isColumnModified(PushDevicePeer::PLATFORM)) {
            $modifiedColumns[':p' . $index++]  = '`platform`';
        }
        if ($this->isColumnModified(PushDevicePeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(PushDevicePeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(PushDevicePeer::ID_GROUP_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_group_creation`';
        }
        if ($this->isColumnModified(PushDevicePeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(PushDevicePeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `push_device` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_push_device`':
                        $stmt->bindValue($identifier, $this->id_push_device, PDO::PARAM_INT);
                        break;
                    case '`id_authy`':
                    ...
                    case '`token`':
                        ...
                        break;
                    case '`platform`':
                        $stmt->bindValue($identifier, $this->platform, PDO::PARAM_INT);
                        break;
                    case '`date_creation`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PushDevicePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PushDevicePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PushDevice'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PushDevice'][$this->getPrimaryKey()] = true;
        $keys = PushDevicePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdPushDevice(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdPushDevice($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PushDevicePeer::ID_PUSH_DEVICE)) $criteria->add(PushDevicePeer::ID_PUSH_DEVICE, $this->id_push_device);
        if ($this->isColumnModified(PushDevicePeer::ID_AUTHY)) $criteria->add(PushDevicePeer::ID_AUTHY, $this->id_authy);
        if ($this->isColumnModified(PushDevicePeer::TOKEN)) $criteria->add(PushDevicePeer::TOKEN, $this->token);
        if ($this->isColumnModified(PushDevicePeer::PLATFORM)) $criteria->add(PushDevicePeer::PLATFORM, $this->platform);
        if ($this->isColumnModified(PushDevicePeer::DATE_CREATION)) $criteria->add(PushDevicePeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(PushDevicePeer::DATE_MODIFICATION)) $criteria->add(PushDevicePeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(PushDevicePeer::ID_GROUP_CREATION)) $criteria->add(PushDevicePeer::ID_GROUP_CREATION, $this->id_group_creation);
        if ($this->isColumnModified(PushDevicePeer::ID_CREATION)) $criteria->add(PushDevicePeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(PushDevicePeer::ID_MODIFICATION)) $criteria->add(PushDevicePeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(PushDevicePeer::DATABASE_NAME);
        $criteria->add(PushDevicePeer::ID_PUSH_DEVICE, $this->id_push_device);
    ...
    {
        return $this->getIdPushDevice();
    }

    /**
     * Generic method to set the primary key (id_push_device column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdPushDevice();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of PushDevice (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdPushDevice(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PushDevice Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PushDevicePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PushDevicePeer();
        }
    ...
    public function setAuthyRelatedByIdAuthy(?Authy $v = null)
    {
        ...
        if ($v !== null) {
            $v->addPushDeviceRelatedByIdAuthy($this);
        }
    ...
    public function getAuthyRelatedByIdAuthy(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdAuthy === null && ($this->id_authy !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAuthyRelatedByIdAuthy->addPushDevicesRelatedByIdAuthy($this);
             */
        }
    ...
    public function getAuthyGroup(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyGroup === null && ($this->id_group_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyGroup->addPushDevices($this);
             */
        }
    ...
    public function setAuthyRelatedByIdCreation(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addPushDeviceRelatedByIdCreation($this);
        }
    ...
    public function getAuthyRelatedByIdCreation(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdCreation === null && ($this->id_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdCreation->addPushDevicesRelatedByIdCreation($this);
             */
        }
    ...
    public function setAuthyRelatedByIdModification(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addPushDeviceRelatedByIdModification($this);
        }
    ...
    public function getAuthyRelatedByIdModification(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdModification === null && ($this->id_modification !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdModification->addPushDevicesRelatedByIdModification($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PushDevicePeer::DEFAULT_STRING_FORMAT);
    }
