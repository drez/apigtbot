...
abstract class BaseAuthyGroupX extends BaseObject implements Persistent
{
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AuthyGroupXPeer::DATE_CREATION;
            }
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AuthyGroupXPeer::DATE_MODIFICATION;
            }
        } // if either are not null
    ...
    public function setIdGroupCreation($v)
    {
        ...
        if ($this->id_group_creation !== $v) {
            ...
            $this->modifiedColumns[] = AuthyGroupXPeer::ID_GROUP_CREATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = AuthyGroupXPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = AuthyGroupXPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = AuthyGroupXPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AuthyGroupXPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(AuthyGroupXPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(AuthyGroupXPeer::ID_GROUP_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_group_creation`';
        }
        if ($this->isColumnModified(AuthyGroupXPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(AuthyGroupXPeer::ID_MODIFICATION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AuthyGroupXPeer::DATE_CREATION)) $criteria->add(AuthyGroupXPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(AuthyGroupXPeer::DATE_MODIFICATION)) $criteria->add(AuthyGroupXPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(AuthyGroupXPeer::ID_GROUP_CREATION)) $criteria->add(AuthyGroupXPeer::ID_GROUP_CREATION, $this->id_group_creation);
        if ($this->isColumnModified(AuthyGroupXPeer::ID_CREATION)) $criteria->add(AuthyGroupXPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(AuthyGroupXPeer::ID_MODIFICATION)) $criteria->add(AuthyGroupXPeer::ID_MODIFICATION, $this->id_modification);
    ...
    public function setAuthyGroupRelatedByIdAuthyGroup(?AuthyGroup $v = null)
    {
        ...
        if ($v !== null) {
            $v->addAuthyGroupXRelatedByIdAuthyGroup($this);
        }
    ...
    public function getAuthyGroupRelatedByIdAuthyGroup(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyGroupRelatedByIdAuthyGroup === null && ($this->id_authy_group !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAuthyGroupRelatedByIdAuthyGroup->addAuthyGroupxesRelatedByIdAuthyGroup($this);
             */
        }
    ...
    public function setAuthyRelatedByIdAuthy(?Authy $v = null)
    {
        ...
        if ($v !== null) {
            $v->addAuthyGroupXRelatedByIdAuthy($this);
        }
    ...
    public function getAuthyRelatedByIdAuthy(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdAuthy === null && ($this->id_authy !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdAuthy->addAuthyGroupxesRelatedByIdAuthy($this);
             */
        }
    ...
    public function setAuthyGroupRelatedByIdGroupCreation(?AuthyGroup $v = null)
    {
        ...
        // If this object has already been added to the AuthyGroup object, it will not be re-added.
        if ($v !== null) {
            $v->addAuthyGroupXRelatedByIdGroupCreation($this);
        }
    ...
    public function getAuthyGroupRelatedByIdGroupCreation(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyGroupRelatedByIdGroupCreation === null && ($this->id_group_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyGroupRelatedByIdGroupCreation->addAuthyGroupxesRelatedByIdGroupCreation($this);
             */
        }
    ...
    public function setAuthyRelatedByIdCreation(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addAuthyGroupXRelatedByIdCreation($this);
        }
    ...
    public function getAuthyRelatedByIdCreation(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdCreation === null && ($this->id_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdCreation->addAuthyGroupxesRelatedByIdCreation($this);
             */
        }
    ...
    public function setAuthyRelatedByIdModification(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addAuthyGroupXRelatedByIdModification($this);
        }
    ...
    public function getAuthyRelatedByIdModification(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdModification === null && ($this->id_modification !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdModification->addAuthyGroupxesRelatedByIdModification($this);
             */
        }
