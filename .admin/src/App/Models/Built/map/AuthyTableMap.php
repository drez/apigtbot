...
class AuthyTableMap extends TableMap
{
  ...
  1 => 'No',
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('FleetSlotRelatedByIdCreation', 'App\\FleetSlot', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_creation', ), null, null, 'FleetSlotsRelatedByIdCreation');
        $this->addRelation('FleetSlotRelatedByIdModification', 'App\\FleetSlot', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_modification', ), null, null, 'FleetSlotsRelatedByIdModification');
        $this->addRelation('RegimeEpisodeRelatedByIdCreation', 'App\\RegimeEpisode', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_creation', ), null, null, 'RegimeEpisodesRelatedByIdCreation');
        $this->addRelation('RegimeEpisodeRelatedByIdModification', 'App\\RegimeEpisode', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_modification', ), null, null, 'RegimeEpisodesRelatedByIdModification');
        ...
        $this->addRelation('MarketCandleRelatedByIdCreation', 'App\\MarketCandle', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_creation', ), null, null, 'MarketCandlesRelatedByIdCreation');
        $this->addRelation('MarketCandleRelatedByIdModification', 'App\\MarketCandle', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_modification', ), null, null, 'MarketCandlesRelatedByIdModification');
        ...
        $this->addRelation('MarketOutlookRelatedByIdCreation', 'App\\MarketOutlook', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_creation', ), null, null, 'MarketOutlooksRelatedByIdCreation');
        $this->addRelation('MarketOutlookRelatedByIdModification', 'App\\MarketOutlook', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_modification', ), null, null, 'MarketOutlooksRelatedByIdModification');
        $this->addRelation('MarketOutlookStateRelatedByIdCreation', 'App\\MarketOutlookState', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_creation', ), null, null, 'MarketOutlookStatesRelatedByIdCreation');
        $this->addRelation('MarketOutlookStateRelatedByIdModification', 'App\\MarketOutlookState', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_modification', ), null, null, 'MarketOutlookStatesRelatedByIdModification');
        $this->addRelation('WalletNavRelatedByIdCreation', 'App\\WalletNav', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_creation', ), null, null, 'WalletNavsRelatedByIdCreation');
        $this->addRelation('WalletNavRelatedByIdModification', 'App\\WalletNav', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_modification', ), null, null, 'WalletNavsRelatedByIdModification');
        ...
        $this->addRelation('GridRunAuditRelatedByIdCreation', 'App\\GridRunAudit', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_creation', ), null, null, 'GridRunAuditsRelatedByIdCreation');
        $this->addRelation('GridRunAuditRelatedByIdModification', 'App\\GridRunAudit', RelationMap::ONE_TO_MANY, array('id_authy' => 'id_modification', ), null, null, 'GridRunAuditsRelatedByIdModification');
