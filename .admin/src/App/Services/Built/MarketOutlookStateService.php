...
class MarketOutlookStateService
{
     ...
     * @var string
     */
    public $virtualClassName = 'MarketOutlookState';
    public $rawRequest;
    public $Form;
    public $contentType;
    public $headers;
    ...
    public function __construct($request, $response, $args )
    {
        ...
        // legacy
        $this->request = $args;
        $this->Form = new MarketOutlookStateFormWrapper($request, $args);
    }
        ...
        switch($this->request['a']){
            ...
            case 'view':
                if ($this->request['a'] === 'edit' && empty($this->request['ui'])) {
                    ...
                    $this->content['onReadyJs'] .= "if(window.gcScreens){history.replaceState({gcEdit:null},'',_SITE_URL+'MarketOutlookState/');gcScreens.openEdit('MarketOutlookState'," . $gcEditPk . ");}";
                } else {
    ...
    */
    public function getApiResponse()
    {
        ...
        $Api = new Api('MarketOutlookState', $this, ['Symbol', 'Verdict', 'VerdictSince', 'PriceAtVerdict', 'Candidate', 'CandidatePasses', 'LastRaw', 'LastPassAt']);
    ...
    public function deleteOne()
    {
        ...
        $obj = $_SESSION[_AUTH_VAR]->loadPkScoped(MarketOutlookStateQuery::class, json_decode($this->request['i']), 'MarketOutlookState', 'd');
        if ($obj) {
    ...
    protected function gcDeleteRow($obj, &$error, &$messages)
    {
        ...
        try {
            ...
            error_log('MarketOutlookState delete refused by a foreign key: ' . $gcDelMsg);
    ...
    public function saveUpdate(): array
    {
        ...
        $data['i'] = ( $data['IdMarketOutlookState'] ) ? $data['IdMarketOutlookState'] : $this->request['i'];
        ...
        if(!empty($data['i'])) {
            ...
            $e = $this->Form->setUpdateDefaultsMarketOutlookState($data);
            if ($e === null) {
            ...
            $e = $this->Form->setCreateDefaultsMarketOutlookState($data);
