...
class BotDecisionService
{
    ...
    */
    public function getApiResponse()
    {
        ...
        $Api = new Api('BotDecision', $this, ['IdGridRun', 'Source', 'PLow', 'PHigh', 'NLevels', 'DeployPct', 'Reason', 'PriceAt', 'RealizedBefore', 'EvalStatus', 'EvalAt', 'AppliedAt', 'CyclesDelta', 'RealizedDelta', 'PriceMovePct', 'Verdict']);
  ...
  array (
    ...
    public function saveUpdate(): array
    {
        ...
        $this->BotDecision['request'] = $this->request;
    ...
    */
    ...
    {
        $this->BotDecision['request'] = $this->request;
        $this->BotDecision['parentId'] = $this->request['data']['ip'];
