...
class GridRunService
{
    ...
    */
    public function getApiResponse()
    {
        ...
        $Api = new Api('GridRun', $this, ['Label', 'Symbol', 'Status', 'KillSwitch', 'Profile', 'Algo', 'Simulated', 'PLow', 'PHigh', 'NLevels', 'Spacing', 'Allocation', 'BudgetQuote', 'DeployPct', 'FeePct', 'MaxPositionQuote', 'MaxOrderQuote', 'DailyLossLimitQuote', 'MaxUnrealizedLossQuote', 'BreakoutBufferPct', 'BreakoutPolicy', 'MaxOpenOrders', 'MaxBuyLevelsBelow', 'TrendTf', 'DonchianPeriod', 'TrendEmaFast', 'TrendEmaSlow', 'AtrPeriod', 'AtrStopMult', 'AtrInitialMult', 'ReentryCooldown', 'EngineState', 'LastTickAt', 'LastPrice', 'BalBase', 'BalQuote', 'SimBalBase', 'SimBalQuote', 'RunUid', 'AppliedGeometry', 'LedgerResetAt']);
    ...
    public function saveUpdate(): array
    {
        ...
        $this->GridRun['request'] = $this->request;
    ...
    */
    ...
    {
        $this->GridRun['request'] = $this->request;
        $this->GridRun['parentId'] = $this->request['data']['ip'];
