...
abstract class BaseApiLog extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the raw_parameters field.
     * @var        string
     */
    ...
    /**
     * Initializes internal state of BaseApiLog object.
     * @see        applyDefaults()
     */
    ...
    /**
     * @Field()
     * Get the [raw_parameters] column value.
     * Raw parameters
     * @return string
     */
    ...
    /**
     * Set the value of [raw_parameters] column.
     * Raw parameters
     * @param  string $v new value
     * @return ApiLog The current object (for fluent API support)
     */
    public function setRawParameters($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->raw_parameters !== $v) {
            $this->raw_parameters = $v;
            $this->modifiedColumns[] = ApiLogPeer::RAW_PARAMETERS;
        }
    ...
    public function setCount($v)
    {
        ...
        if ($this->count !== $v) {
            $this->count = $v;
            $this->modifiedColumns[] = ApiLogPeer::COUNT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->raw_parameters = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            ...
            return $startcol + 6; // 6 = ApiLogPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ApiLogPeer::RAW_PARAMETERS)) {
            $modifiedColumns[':p' . $index++]  = '`raw_parameters`';
        }
        if ($this->isColumnModified(ApiLogPeer::COUNT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`time`':
                        ...
                        break;
                    case '`raw_parameters`':
                        $stmt->bindValue($identifier, $this->raw_parameters, PDO::PARAM_STR);
                        break;
                    case '`count`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setRawParameters($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ApiLogPeer::RAW_PARAMETERS)) $criteria->add(ApiLogPeer::RAW_PARAMETERS, $this->raw_parameters);
        if ($this->isColumnModified(ApiLogPeer::COUNT)) $criteria->add(ApiLogPeer::COUNT, $this->count);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setRawParameters($this->getRawParameters());
