...
class RegimeEpisodeService
{
     ...
     * @var string
     */
    public $virtualClassName = 'RegimeEpisode';
    public $rawRequest;
    public $Form;
    public $contentType;
    public $headers;
    ...
    public function __construct($request, $response, $args )
    {
        ...
        // legacy
        $this->request = $args;
        $this->Form = new RegimeEpisodeFormWrapper($request, $args);
    }
        ...
        switch($this->request['a']){
            ...
            case 'view':
                if ($this->request['a'] === 'edit' && empty($this->request['ui'])) {
                    ...
                    $this->content['onReadyJs'] .= "if(window.gcScreens){history.replaceState({gcEdit:null},'',_SITE_URL+'RegimeEpisode/');gcScreens.openEdit('RegimeEpisode'," . $gcEditPk . ");}";
                } else {
    ...
    */
    public function getApiResponse()
    {
        ...
        $Api = new Api('RegimeEpisode', $this, ['Symbol', 'Algo', 'IdFleetSlot', 'IdGridRun', 'Verdict', 'OpenedAt', 'ClosedAt', 'PriceOpen', 'PriceClose', 'EngagedPctTw', 'Samples', 'Realized', 'MtmClose', 'HodlPct', 'CapturedPct', 'IdleSamples', 'IdleAlertedAt']);
  ...
  array (
    ...
    public function deleteOne()
    {
        ...
        $obj = $_SESSION[_AUTH_VAR]->loadPkScoped(RegimeEpisodeQuery::class, json_decode($this->request['i']), 'RegimeEpisode', 'd');
        if ($obj) {
    ...
    protected function gcDeleteRow($obj, &$error, &$messages)
    {
        ...
        try {
            ...
            error_log('RegimeEpisode delete refused by a foreign key: ' . $gcDelMsg);
    ...
    public function saveUpdate(): array
    {
        ...
        $data['i'] = ( $data['IdRegimeEpisode'] ) ? $data['IdRegimeEpisode'] : $this->request['i'];
        ...
        if(!empty($data['i'])) {
            ...
            $e = $this->Form->setUpdateDefaultsRegimeEpisode($data);
            if ($e === null) {
            ...
            $e = $this->Form->setCreateDefaultsRegimeEpisode($data);
