...
/**
 * Base class that represents a row from the 'oauth_refresh_token' table.
 *
 *
 *
 * @package    propel.generator..om
 */
abstract class BaseOauthRefreshToken extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'App\\OauthRefreshTokenPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        OauthRefreshTokenPeer
     */
    ...
    /**
     * The value for the access_token_id field.
     * @var        string
     */
    ...
    /**
     * Initializes internal state of BaseOauthRefreshToken object.
     * @see        applyDefaults()
     */
    ...
    /**
     * @Field()
     * Get the [access_token_id] column value.
     *
     * @return string
     */
    ...
    public function getRevoked()
    {
        ...
        $valueSet = OauthRefreshTokenPeer::getValueSet(OauthRefreshTokenPeer::REVOKED);
     ...
     * @return OauthRefreshToken The current object (for fluent API support)
     */
    public function setIdOauthRefreshToken($v)
    {
        ...
        if ($this->id_oauth_refresh_token !== $v) {
            $this->id_oauth_refresh_token = $v;
            $this->modifiedColumns[] = OauthRefreshTokenPeer::ID_OAUTH_REFRESH_TOKEN;
        }
    ...
    public function setTokenId($v)
    {
        ...
        if ($this->token_id !== $v) {
            $this->token_id = $v;
            $this->modifiedColumns[] = OauthRefreshTokenPeer::TOKEN_ID;
        }
    ...
    /**
     * Set the value of [access_token_id] column.
     *
     * @param  string $v new value
     * @return OauthRefreshToken The current object (for fluent API support)
     */
    public function setAccessTokenId($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->access_token_id !== $v) {
            $this->access_token_id = $v;
            $this->modifiedColumns[] = OauthRefreshTokenPeer::ACCESS_TOKEN_ID;
        }
    ...
    public function setIdAuthy($v)
    {
        ...
        if ($this->id_authy !== $v) {
            $this->id_authy = $v;
            $this->modifiedColumns[] = OauthRefreshTokenPeer::ID_AUTHY;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[] = OauthRefreshTokenPeer::CLIENT_ID;
        }
    ...
    public function setExpires($v)
    {
        ...
        if ($this->expires !== $v) {
            $this->expires = $v;
            $this->modifiedColumns[] = OauthRefreshTokenPeer::EXPIRES;
        }
    ...
    public function setRevoked($v)
    {
        ...
        if ($this->revoked !== $v) {
            $this->revoked = $v;
            $this->modifiedColumns[] = OauthRefreshTokenPeer::REVOKED;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OauthRefreshTokenPeer::CREATED_AT;
            }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OauthRefreshTokenPeer::DATE_CREATION;
            }
        } // if either are not null
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OauthRefreshTokenPeer::DATE_MODIFICATION;
            }
        } // if either are not null
    ...
    public function setIdGroupCreation($v)
    {
        ...
        if ($this->id_group_creation !== $v) {
            ...
            $this->modifiedColumns[] = OauthRefreshTokenPeer::ID_GROUP_CREATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = OauthRefreshTokenPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = OauthRefreshTokenPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_oauth_refresh_token = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->token_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->access_token_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->id_authy = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->client_id = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            ...
            return $startcol + 13; // 13 = OauthRefreshTokenPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating OauthRefreshToken object", $e);
        }
    }
    ...
    public function reload($deep = false, ?PropelPDO $con = null)
    {
        ...
        $stmt = OauthRefreshTokenPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(?PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OauthRefreshTokenQuery::create()
    ...
    public function save(?PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                OauthRefreshTokenPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OauthRefreshTokenPeer::ID_OAUTH_REFRESH_TOKEN)) {
            $modifiedColumns[':p' . $index++]  = '`id_oauth_refresh_token`';
        }
        if ($this->isColumnModified(OauthRefreshTokenPeer::TOKEN_ID)) {
            $modifiedColumns[':p' . $index++]  = '`token_id`';
        }
        if ($this->isColumnModified(OauthRefreshTokenPeer::ACCESS_TOKEN_ID)) {
            $modifiedColumns[':p' . $index++]  = '`access_token_id`';
        }
        if ($this->isColumnModified(OauthRefreshTokenPeer::ID_AUTHY)) {
            $modifiedColumns[':p' . $index++]  = '`id_authy`';
        }
        if ($this->isColumnModified(OauthRefreshTokenPeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`client_id`';
        }
        if ($this->isColumnModified(OauthRefreshTokenPeer::EXPIRES)) {
            $modifiedColumns[':p' . $index++]  = '`expires`';
        }
        if ($this->isColumnModified(OauthRefreshTokenPeer::REVOKED)) {
            $modifiedColumns[':p' . $index++]  = '`revoked`';
        }
        if ($this->isColumnModified(OauthRefreshTokenPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(OauthRefreshTokenPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(OauthRefreshTokenPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(OauthRefreshTokenPeer::ID_GROUP_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_group_creation`';
        }
        if ($this->isColumnModified(OauthRefreshTokenPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(OauthRefreshTokenPeer::ID_MODIFICATION)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`access_token_id`':
                        $stmt->bindValue($identifier, $this->access_token_id, PDO::PARAM_STR);
                        break;
                    case '`id_authy`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OauthRefreshTokenPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OauthRefreshTokenPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OauthRefreshToken'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OauthRefreshToken'][$this->getPrimaryKey()] = true;
        $keys = OauthRefreshTokenPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdOauthRefreshToken(),
            $keys[1] => $this->getTokenId(),
            $keys[2] => $this->getAccessTokenId(),
            $keys[3] => $this->getIdAuthy(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdOauthRefreshToken($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setTokenId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setAccessTokenId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setIdAuthy($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setClientId($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OauthRefreshTokenPeer::ID_OAUTH_REFRESH_TOKEN)) $criteria->add(OauthRefreshTokenPeer::ID_OAUTH_REFRESH_TOKEN, $this->id_oauth_refresh_token);
        if ($this->isColumnModified(OauthRefreshTokenPeer::TOKEN_ID)) $criteria->add(OauthRefreshTokenPeer::TOKEN_ID, $this->token_id);
        if ($this->isColumnModified(OauthRefreshTokenPeer::ACCESS_TOKEN_ID)) $criteria->add(OauthRefreshTokenPeer::ACCESS_TOKEN_ID, $this->access_token_id);
        if ($this->isColumnModified(OauthRefreshTokenPeer::ID_AUTHY)) $criteria->add(OauthRefreshTokenPeer::ID_AUTHY, $this->id_authy);
        if ($this->isColumnModified(OauthRefreshTokenPeer::CLIENT_ID)) $criteria->add(OauthRefreshTokenPeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(OauthRefreshTokenPeer::EXPIRES)) $criteria->add(OauthRefreshTokenPeer::EXPIRES, $this->expires);
        if ($this->isColumnModified(OauthRefreshTokenPeer::REVOKED)) $criteria->add(OauthRefreshTokenPeer::REVOKED, $this->revoked);
        if ($this->isColumnModified(OauthRefreshTokenPeer::CREATED_AT)) $criteria->add(OauthRefreshTokenPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(OauthRefreshTokenPeer::DATE_CREATION)) $criteria->add(OauthRefreshTokenPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(OauthRefreshTokenPeer::DATE_MODIFICATION)) $criteria->add(OauthRefreshTokenPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(OauthRefreshTokenPeer::ID_GROUP_CREATION)) $criteria->add(OauthRefreshTokenPeer::ID_GROUP_CREATION, $this->id_group_creation);
        if ($this->isColumnModified(OauthRefreshTokenPeer::ID_CREATION)) $criteria->add(OauthRefreshTokenPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(OauthRefreshTokenPeer::ID_MODIFICATION)) $criteria->add(OauthRefreshTokenPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(OauthRefreshTokenPeer::DATABASE_NAME);
        $criteria->add(OauthRefreshTokenPeer::ID_OAUTH_REFRESH_TOKEN, $this->id_oauth_refresh_token);
     ...
     * objects.
     *
     * @param object $copyObj An object of OauthRefreshToken (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setAccessTokenId($this->getAccessTokenId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OauthRefreshToken Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OauthRefreshTokenPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OauthRefreshTokenPeer();
        }
    ...
    public function setAuthyRelatedByIdAuthy(?Authy $v = null)
    {
        ...
        if ($v !== null) {
            $v->addOauthRefreshTokenRelatedByIdAuthy($this);
        }
    ...
    public function getAuthyRelatedByIdAuthy(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdAuthy === null && ($this->id_authy !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAuthyRelatedByIdAuthy->addOauthRefreshTokensRelatedByIdAuthy($this);
             */
        }
    ...
    public function getAuthyGroup(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyGroup === null && ($this->id_group_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyGroup->addOauthRefreshTokens($this);
             */
        }
    ...
    public function setAuthyRelatedByIdCreation(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addOauthRefreshTokenRelatedByIdCreation($this);
        }
    ...
    public function getAuthyRelatedByIdCreation(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdCreation === null && ($this->id_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdCreation->addOauthRefreshTokensRelatedByIdCreation($this);
             */
        }
    ...
    public function setAuthyRelatedByIdModification(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addOauthRefreshTokenRelatedByIdModification($this);
        }
    ...
    public function getAuthyRelatedByIdModification(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdModification === null && ($this->id_modification !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdModification->addOauthRefreshTokensRelatedByIdModification($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(OauthRefreshTokenPeer::DEFAULT_STRING_FORMAT);
    }
