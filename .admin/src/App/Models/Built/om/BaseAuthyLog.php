...
abstract class BaseAuthyLog extends BaseObject implements Persistent
{
    ...
    public function setEvent($v)
    {
        ...
        if ($this->event !== $v) {
            $this->event = $v;
            $this->modifiedColumns[] = AuthyLogPeer::EVENT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->count = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
            $this->resetModified();
            ...
            return $startcol + 9; // 9 = AuthyLogPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AuthyLogPeer::EVENT)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[8], $arr)) $this->setCount($arr[$keys[8]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AuthyLogPeer::EVENT)) $criteria->add(AuthyLogPeer::EVENT, $this->event);
