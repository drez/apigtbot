...
/**
 * Base class that represents a row from the 'grid_run_audit' table.
 *
 * Change history
 *
 * @package    propel.generator..om
 */
abstract class BaseGridRunAudit extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'App\\GridRunAuditPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GridRunAuditPeer
     */
    ...
    /**
     * The value for the id_grid_run_audit field.
     * @var        int
     */
    protected $id_grid_run_audit;
    ...
    /**
     * The value for the value_to field.
     * @var        string
     */
    protected $value_to;

    /**
     * The value for the actor field.
     * @var        string
     */
    protected $actor;
    ...
    /**
     * Initializes internal state of BaseGridRunAudit object.
     * @see        applyDefaults()
     */
    ...
    /**
     * @Field()
     * Get the [id_grid_run_audit] column value.
     *
     * @return int
     */
    public function getIdGridRunAudit()
    {

        return $this->id_grid_run_audit;
    }
    ...
    public function getSource()
    {
        ...
        $valueSet = GridRunAuditPeer::getValueSet(GridRunAuditPeer::SOURCE);
    ...
    /**
     * Set the value of [id_grid_run_audit] column.
     *
     * @param  int $v new value
     * @return GridRunAudit The current object (for fluent API support)
     */
    public function setIdGridRunAudit($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_grid_run_audit !== $v) {
            $this->id_grid_run_audit = $v;
            $this->modifiedColumns[] = GridRunAuditPeer::ID_GRID_RUN_AUDIT;
        }
    ...
    public function setIdGridRun($v)
    {
        ...
        if ($this->id_grid_run !== $v) {
            $this->id_grid_run = $v;
            $this->modifiedColumns[] = GridRunAuditPeer::ID_GRID_RUN;
        }
    ...
    public function setField($v)
    {
        ...
        if ($this->field !== $v) {
            $this->field = $v;
            $this->modifiedColumns[] = GridRunAuditPeer::FIELD;
        }
    ...
    public function setValueFrom($v)
    {
        ...
        if ($this->value_from !== $v) {
            $this->value_from = $v;
            $this->modifiedColumns[] = GridRunAuditPeer::VALUE_FROM;
        }
    ...
    /**
     * Set the value of [value_to] column.
     * To
     * @param  string $v new value
     * @return GridRunAudit The current object (for fluent API support)
     */
    public function setValueTo($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->value_to !== $v) {
            $this->value_to = $v;
            $this->modifiedColumns[] = GridRunAuditPeer::VALUE_TO;
        }
    ...
    public function setActor($v)
    {
        ...
        if ($this->actor !== $v) {
            $this->actor = $v;
            $this->modifiedColumns[] = GridRunAuditPeer::ACTOR;
        }
    ...
    public function setSource($v)
    {
        ...
        if ($this->source !== $v) {
            $this->source = $v;
            $this->modifiedColumns[] = GridRunAuditPeer::SOURCE;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = GridRunAuditPeer::DATE_CREATION;
            }
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = GridRunAuditPeer::DATE_MODIFICATION;
            }
        } // if either are not null
    ...
    public function setIdGroupCreation($v)
    {
        ...
        if ($this->id_group_creation !== $v) {
            ...
            $this->modifiedColumns[] = GridRunAuditPeer::ID_GROUP_CREATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = GridRunAuditPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = GridRunAuditPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_grid_run_audit = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->id_grid_run = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->field = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->value_from = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->value_to = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->actor = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->source = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            ...
            return $startcol + 12; // 12 = GridRunAuditPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GridRunAudit object", $e);
        }
    }
    ...
    public function reload($deep = false, ?PropelPDO $con = null)
    {
        ...
        $stmt = GridRunAuditPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(?PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GridRunAuditQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // GoatCheese behavior

                        // add_audit behavior: the history is append-only
                        throw new PropelException('audit history is append-only; rows are written by the audited table\'s save (delete refused)');
            if ($ret) {
    ...
    public function save(?PropelPDO $con = null)
    {
        ...
        try {
            ...
            // GoatCheese behavior
                        ...
                        // add_audit behavior: the history is append-only
                        throw new PropelException('audit history is append-only; rows are written by the audited table\'s save (save refused)');
            if ($isInsert) {
            ...
            if ($ret) {
                ...
                GridRunAuditPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = GridRunAuditPeer::ID_GRID_RUN_AUDIT;
        if (null !== $this->id_grid_run_audit) {
        ...
        if ($this->isColumnModified(GridRunAuditPeer::ID_GRID_RUN_AUDIT)) {
            $modifiedColumns[':p' . $index++]  = '`id_grid_run_audit`';
        }
        if ($this->isColumnModified(GridRunAuditPeer::ID_GRID_RUN)) {
            $modifiedColumns[':p' . $index++]  = '`id_grid_run`';
        }
        if ($this->isColumnModified(GridRunAuditPeer::FIELD)) {
            $modifiedColumns[':p' . $index++]  = '`field`';
        }
        if ($this->isColumnModified(GridRunAuditPeer::VALUE_FROM)) {
            $modifiedColumns[':p' . $index++]  = '`value_from`';
        }
        if ($this->isColumnModified(GridRunAuditPeer::VALUE_TO)) {
            $modifiedColumns[':p' . $index++]  = '`value_to`';
        }
        if ($this->isColumnModified(GridRunAuditPeer::ACTOR)) {
            $modifiedColumns[':p' . $index++]  = '`actor`';
        }
        if ($this->isColumnModified(GridRunAuditPeer::SOURCE)) {
            $modifiedColumns[':p' . $index++]  = '`source`';
        }
        if ($this->isColumnModified(GridRunAuditPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(GridRunAuditPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(GridRunAuditPeer::ID_GROUP_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_group_creation`';
        }
        if ($this->isColumnModified(GridRunAuditPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(GridRunAuditPeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `grid_run_audit` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_grid_run_audit`':
                        $stmt->bindValue($identifier, $this->id_grid_run_audit, PDO::PARAM_INT);
                        break;
                    case '`id_grid_run`':
                    ...
                    case '`field`':
                        ...
                        break;
                    case '`value_from`':
                        $stmt->bindValue($identifier, $this->value_from, PDO::PARAM_STR);
                        break;
                    case '`value_to`':
                        $stmt->bindValue($identifier, $this->value_to, PDO::PARAM_STR);
                        break;
                    case '`actor`':
                        $stmt->bindValue($identifier, $this->actor, PDO::PARAM_STR);
                        break;
                    case '`source`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GridRunAuditPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GridRunAuditPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GridRunAudit'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GridRunAudit'][$this->getPrimaryKey()] = true;
        $keys = GridRunAuditPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdGridRunAudit(),
            $keys[1] => $this->getIdGridRun(),
            $keys[2] => $this->getField(),
            $keys[3] => $this->getValueFrom(),
            $keys[4] => $this->getValueTo(),
            $keys[5] => $this->getActor(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdGridRunAudit($arr[$keys[0]]);
        ...
        if (array_key_exists($keys[4], $arr)) $this->setValueTo($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setActor($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GridRunAuditPeer::ID_GRID_RUN_AUDIT)) $criteria->add(GridRunAuditPeer::ID_GRID_RUN_AUDIT, $this->id_grid_run_audit);
        if ($this->isColumnModified(GridRunAuditPeer::ID_GRID_RUN)) $criteria->add(GridRunAuditPeer::ID_GRID_RUN, $this->id_grid_run);
        if ($this->isColumnModified(GridRunAuditPeer::FIELD)) $criteria->add(GridRunAuditPeer::FIELD, $this->field);
        if ($this->isColumnModified(GridRunAuditPeer::VALUE_FROM)) $criteria->add(GridRunAuditPeer::VALUE_FROM, $this->value_from);
        if ($this->isColumnModified(GridRunAuditPeer::VALUE_TO)) $criteria->add(GridRunAuditPeer::VALUE_TO, $this->value_to);
        if ($this->isColumnModified(GridRunAuditPeer::ACTOR)) $criteria->add(GridRunAuditPeer::ACTOR, $this->actor);
        if ($this->isColumnModified(GridRunAuditPeer::SOURCE)) $criteria->add(GridRunAuditPeer::SOURCE, $this->source);
        if ($this->isColumnModified(GridRunAuditPeer::DATE_CREATION)) $criteria->add(GridRunAuditPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(GridRunAuditPeer::DATE_MODIFICATION)) $criteria->add(GridRunAuditPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(GridRunAuditPeer::ID_GROUP_CREATION)) $criteria->add(GridRunAuditPeer::ID_GROUP_CREATION, $this->id_group_creation);
        if ($this->isColumnModified(GridRunAuditPeer::ID_CREATION)) $criteria->add(GridRunAuditPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(GridRunAuditPeer::ID_MODIFICATION)) $criteria->add(GridRunAuditPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(GridRunAuditPeer::DATABASE_NAME);
        $criteria->add(GridRunAuditPeer::ID_GRID_RUN_AUDIT, $this->id_grid_run_audit);
    ...
    {
        return $this->getIdGridRunAudit();
    }

    /**
     * Generic method to set the primary key (id_grid_run_audit column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdGridRunAudit();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of GridRunAudit (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setValueFrom($this->getValueFrom());
        $copyObj->setValueTo($this->getValueTo());
        $copyObj->setActor($this->getActor());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdGridRunAudit(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GridRunAudit Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GridRunAuditPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GridRunAuditPeer();
        }
    ...
    public function getGridRun(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aGridRun === null && ($this->id_grid_run !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGridRun->addGridRunAudits($this);
             */
        }
    ...
    public function getAuthyGroup(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyGroup === null && ($this->id_group_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyGroup->addGridRunAudits($this);
             */
        }
    ...
    public function setAuthyRelatedByIdCreation(?Authy $v = null)
    {
        ...
        if ($v !== null) {
            $v->addGridRunAuditRelatedByIdCreation($this);
        }
    ...
    public function getAuthyRelatedByIdCreation(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdCreation === null && ($this->id_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdCreation->addGridRunAuditsRelatedByIdCreation($this);
             */
        }
    ...
    public function setAuthyRelatedByIdModification(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addGridRunAuditRelatedByIdModification($this);
        }
    ...
    public function getAuthyRelatedByIdModification(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdModification === null && ($this->id_modification !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdModification->addGridRunAuditsRelatedByIdModification($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(GridRunAuditPeer::DEFAULT_STRING_FORMAT);
    }
