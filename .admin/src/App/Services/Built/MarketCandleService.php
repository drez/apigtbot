...
class MarketCandleService
{
     ...
     * @var string
     */
    public $virtualClassName = 'MarketCandle';
    public $rawRequest;
    public $Form;
    public $contentType;
    public $headers;
    ...
    public function __construct($request, $response, $args )
    {
        ...
        // legacy
        $this->request = $args;
        $this->Form = new MarketCandleFormWrapper($request, $args);
    }
        ...
        switch($this->request['a']){
            ...
            case 'view':
                if ($this->request['a'] === 'edit' && empty($this->request['ui'])) {
                    ...
                    $this->content['onReadyJs'] .= "if(window.gcScreens){history.replaceState({gcEdit:null},'',_SITE_URL+'MarketCandle/');gcScreens.openEdit('MarketCandle'," . $gcEditPk . ");}";
                } else {
    ...
    */
    public function getApiResponse()
    {
        ...
        $Api = new Api('MarketCandle', $this, ['Symbol', 'Tf', 'OpenTime', 'Open', 'High', 'Low', 'Close', 'Volume']);
    ...
    public function deleteOne()
    {
        ...
        $obj = $_SESSION[_AUTH_VAR]->loadPkScoped(MarketCandleQuery::class, json_decode($this->request['i']), 'MarketCandle', 'd');
        if ($obj) {
    ...
    protected function gcDeleteRow($obj, &$error, &$messages)
    {
        ...
        try {
            ...
            error_log('MarketCandle delete refused by a foreign key: ' . $gcDelMsg);
    ...
    public function saveUpdate(): array
    {
        ...
        $data['i'] = ( $data['IdMarketCandle'] ) ? $data['IdMarketCandle'] : $this->request['i'];
        ...
        if(!empty($data['i'])) {
            ...
            $e = $this->Form->setUpdateDefaultsMarketCandle($data);
            if ($e === null) {
            ...
            $e = $this->Form->setCreateDefaultsMarketCandle($data);
