...
class MarketSummaryService
{
     ...
     * @var string
     */
    public $virtualClassName = 'MarketSummary';
    public $rawRequest;
    public $Form;
    public $contentType;
    public $headers;
    ...
    public function __construct($request, $response, $args )
    {
        ...
        // legacy
        $this->request = $args;
        $this->Form = new MarketSummaryFormWrapper($request, $args);
    }
        ...
        switch($this->request['a']){
            ...
            case 'view':
                if ($this->request['a'] === 'edit' && empty($this->request['ui'])) {
                    ...
                    $this->content['onReadyJs'] .= "if(window.gcScreens){history.replaceState({gcEdit:null},'',_SITE_URL+'MarketSummary/');gcScreens.openEdit('MarketSummary'," . $gcEditPk . ");}";
                } else {
    ...
    */
    ...
    public function deleteOne()
    {
        ...
        $obj = $_SESSION[_AUTH_VAR]->loadPkScoped(MarketSummaryQuery::class, json_decode($this->request['i']), 'MarketSummary', 'd');
        if ($obj) {
    ...
    protected function gcDeleteRow($obj, &$error, &$messages)
    {
        ...
        try {
            ...
            error_log('MarketSummary delete refused by a foreign key: ' . $gcDelMsg);
    ...
    public function saveUpdate(): array
    {
        ...
        $data['i'] = ( $data['IdMarketSummary'] ) ? $data['IdMarketSummary'] : $this->request['i'];
        ...
        if(!empty($data['i'])) {
            ...
            $e = $this->Form->setUpdateDefaultsMarketSummary($data);
            if ($e === null) {
            ...
            $e = $this->Form->setCreateDefaultsMarketSummary($data);
