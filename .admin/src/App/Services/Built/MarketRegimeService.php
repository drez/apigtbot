...
class MarketRegimeService
{
     ...
     * @var string
     */
    public $virtualClassName = 'MarketRegime';
    public $rawRequest;
    public $Form;
    public $contentType;
    public $headers;
    ...
    public function __construct($request, $response, $args )
    {
        ...
        // legacy
        $this->request = $args;
        $this->Form = new MarketRegimeFormWrapper($request, $args);
    }
        ...
        switch($this->request['a']){
            ...
            case 'view':
                if ($this->request['a'] === 'edit' && empty($this->request['ui'])) {
                    ...
                    $this->content['onReadyJs'] .= "if(window.gcScreens){history.replaceState({gcEdit:null},'',_SITE_URL+'MarketRegime/');gcScreens.openEdit('MarketRegime'," . $gcEditPk . ");}";
                } else {
    ...
    */
    ...
    public function deleteOne()
    {
        ...
        $obj = $_SESSION[_AUTH_VAR]->loadPkScoped(MarketRegimeQuery::class, json_decode($this->request['i']), 'MarketRegime', 'd');
        if ($obj) {
    ...
    protected function gcDeleteRow($obj, &$error, &$messages)
    {
        ...
        try {
            ...
            error_log('MarketRegime delete refused by a foreign key: ' . $gcDelMsg);
    ...
    public function saveUpdate(): array
    {
        ...
        $data['i'] = ( $data['IdMarketRegime'] ) ? $data['IdMarketRegime'] : $this->request['i'];
        ...
        if(!empty($data['i'])) {
            ...
            $e = $this->Form->setUpdateDefaultsMarketRegime($data);
            if ($e === null) {
            ...
            $e = $this->Form->setCreateDefaultsMarketRegime($data);
