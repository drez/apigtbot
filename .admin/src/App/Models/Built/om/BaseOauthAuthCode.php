...
/**
 * Base class that represents a row from the 'oauth_auth_code' table.
 *
 *
 *
 * @package    propel.generator..om
 */
abstract class BaseOauthAuthCode extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'App\\OauthAuthCodePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        OauthAuthCodePeer
     */
    ...
    /**
     * The value for the id_oauth_auth_code field.
     * @var        int
     */
    protected $id_oauth_auth_code;
    ...
    /**
     * Initializes internal state of BaseOauthAuthCode object.
     * @see        applyDefaults()
     */
    ...
    /**
     * @Field()
     * Get the [id_oauth_auth_code] column value.
     *
     * @return int
     */
    public function getIdOauthAuthCode()
    {

        return $this->id_oauth_auth_code;
    }
    ...
    public function getRevoked()
    {
        ...
        $valueSet = OauthAuthCodePeer::getValueSet(OauthAuthCodePeer::REVOKED);
    ...
    /**
     * Set the value of [id_oauth_auth_code] column.
     *
     * @param  int $v new value
     * @return OauthAuthCode The current object (for fluent API support)
     */
    public function setIdOauthAuthCode($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_oauth_auth_code !== $v) {
            $this->id_oauth_auth_code = $v;
            $this->modifiedColumns[] = OauthAuthCodePeer::ID_OAUTH_AUTH_CODE;
        }
    ...
    public function setCodeId($v)
    {
        ...
        if ($this->code_id !== $v) {
            $this->code_id = $v;
            $this->modifiedColumns[] = OauthAuthCodePeer::CODE_ID;
        }
    ...
    public function setIdAuthy($v)
    {
        ...
        if ($this->id_authy !== $v) {
            $this->id_authy = $v;
            $this->modifiedColumns[] = OauthAuthCodePeer::ID_AUTHY;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[] = OauthAuthCodePeer::CLIENT_ID;
        }
    ...
    public function setScopes($v)
    {
        ...
        if ($this->scopes !== $v) {
            $this->scopes = $v;
            $this->modifiedColumns[] = OauthAuthCodePeer::SCOPES;
        }
    ...
    public function setExpires($v)
    {
        ...
        if ($this->expires !== $v) {
            $this->expires = $v;
            $this->modifiedColumns[] = OauthAuthCodePeer::EXPIRES;
        }
    ...
    public function setRevoked($v)
    {
        ...
        if ($this->revoked !== $v) {
            $this->revoked = $v;
            $this->modifiedColumns[] = OauthAuthCodePeer::REVOKED;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OauthAuthCodePeer::CREATED_AT;
            }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OauthAuthCodePeer::DATE_CREATION;
            }
        } // if either are not null
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OauthAuthCodePeer::DATE_MODIFICATION;
            }
        } // if either are not null
    ...
    public function setIdGroupCreation($v)
    {
        ...
        if ($this->id_group_creation !== $v) {
            ...
            $this->modifiedColumns[] = OauthAuthCodePeer::ID_GROUP_CREATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = OauthAuthCodePeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = OauthAuthCodePeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_oauth_auth_code = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->code_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = OauthAuthCodePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating OauthAuthCode object", $e);
        }
    }
    ...
    public function reload($deep = false, ?PropelPDO $con = null)
    {
        ...
        $stmt = OauthAuthCodePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(?PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OauthAuthCodeQuery::create()
    ...
    public function save(?PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                OauthAuthCodePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = OauthAuthCodePeer::ID_OAUTH_AUTH_CODE;
        if (null !== $this->id_oauth_auth_code) {
        ...
        if ($this->isColumnModified(OauthAuthCodePeer::ID_OAUTH_AUTH_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`id_oauth_auth_code`';
        }
        if ($this->isColumnModified(OauthAuthCodePeer::CODE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`code_id`';
        }
        if ($this->isColumnModified(OauthAuthCodePeer::ID_AUTHY)) {
            $modifiedColumns[':p' . $index++]  = '`id_authy`';
        }
        if ($this->isColumnModified(OauthAuthCodePeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`client_id`';
        }
        if ($this->isColumnModified(OauthAuthCodePeer::SCOPES)) {
            $modifiedColumns[':p' . $index++]  = '`scopes`';
        }
        if ($this->isColumnModified(OauthAuthCodePeer::EXPIRES)) {
            $modifiedColumns[':p' . $index++]  = '`expires`';
        }
        if ($this->isColumnModified(OauthAuthCodePeer::REVOKED)) {
            $modifiedColumns[':p' . $index++]  = '`revoked`';
        }
        if ($this->isColumnModified(OauthAuthCodePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(OauthAuthCodePeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(OauthAuthCodePeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(OauthAuthCodePeer::ID_GROUP_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_group_creation`';
        }
        if ($this->isColumnModified(OauthAuthCodePeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(OauthAuthCodePeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `oauth_auth_code` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_oauth_auth_code`':
                        $stmt->bindValue($identifier, $this->id_oauth_auth_code, PDO::PARAM_INT);
                        break;
                    case '`code_id`':
                        $stmt->bindValue($identifier, $this->code_id, PDO::PARAM_STR);
                        break;
                    case '`id_authy`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OauthAuthCodePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OauthAuthCodePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OauthAuthCode'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OauthAuthCode'][$this->getPrimaryKey()] = true;
        $keys = OauthAuthCodePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdOauthAuthCode(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdOauthAuthCode($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OauthAuthCodePeer::ID_OAUTH_AUTH_CODE)) $criteria->add(OauthAuthCodePeer::ID_OAUTH_AUTH_CODE, $this->id_oauth_auth_code);
        if ($this->isColumnModified(OauthAuthCodePeer::CODE_ID)) $criteria->add(OauthAuthCodePeer::CODE_ID, $this->code_id);
        if ($this->isColumnModified(OauthAuthCodePeer::ID_AUTHY)) $criteria->add(OauthAuthCodePeer::ID_AUTHY, $this->id_authy);
        if ($this->isColumnModified(OauthAuthCodePeer::CLIENT_ID)) $criteria->add(OauthAuthCodePeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(OauthAuthCodePeer::SCOPES)) $criteria->add(OauthAuthCodePeer::SCOPES, $this->scopes);
        if ($this->isColumnModified(OauthAuthCodePeer::EXPIRES)) $criteria->add(OauthAuthCodePeer::EXPIRES, $this->expires);
        if ($this->isColumnModified(OauthAuthCodePeer::REVOKED)) $criteria->add(OauthAuthCodePeer::REVOKED, $this->revoked);
        if ($this->isColumnModified(OauthAuthCodePeer::CREATED_AT)) $criteria->add(OauthAuthCodePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(OauthAuthCodePeer::DATE_CREATION)) $criteria->add(OauthAuthCodePeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(OauthAuthCodePeer::DATE_MODIFICATION)) $criteria->add(OauthAuthCodePeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(OauthAuthCodePeer::ID_GROUP_CREATION)) $criteria->add(OauthAuthCodePeer::ID_GROUP_CREATION, $this->id_group_creation);
        if ($this->isColumnModified(OauthAuthCodePeer::ID_CREATION)) $criteria->add(OauthAuthCodePeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(OauthAuthCodePeer::ID_MODIFICATION)) $criteria->add(OauthAuthCodePeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(OauthAuthCodePeer::DATABASE_NAME);
        $criteria->add(OauthAuthCodePeer::ID_OAUTH_AUTH_CODE, $this->id_oauth_auth_code);
    ...
    {
        return $this->getIdOauthAuthCode();
    }

    /**
     * Generic method to set the primary key (id_oauth_auth_code column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdOauthAuthCode();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of OauthAuthCode (or compatible) type.
    ...
    {
        $copyObj->setCodeId($this->getCodeId());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdOauthAuthCode(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OauthAuthCode Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OauthAuthCodePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OauthAuthCodePeer();
        }
    ...
    public function setAuthyRelatedByIdAuthy(?Authy $v = null)
    {
        ...
        if ($v !== null) {
            $v->addOauthAuthCodeRelatedByIdAuthy($this);
        }
    ...
    public function getAuthyRelatedByIdAuthy(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdAuthy === null && ($this->id_authy !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAuthyRelatedByIdAuthy->addOauthAuthCodesRelatedByIdAuthy($this);
             */
        }
    ...
    public function getAuthyGroup(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyGroup === null && ($this->id_group_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyGroup->addOauthAuthCodes($this);
             */
        }
    ...
    public function setAuthyRelatedByIdCreation(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addOauthAuthCodeRelatedByIdCreation($this);
        }
    ...
    public function getAuthyRelatedByIdCreation(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdCreation === null && ($this->id_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdCreation->addOauthAuthCodesRelatedByIdCreation($this);
             */
        }
    ...
    public function setAuthyRelatedByIdModification(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addOauthAuthCodeRelatedByIdModification($this);
        }
    ...
    public function getAuthyRelatedByIdModification(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdModification === null && ($this->id_modification !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdModification->addOauthAuthCodesRelatedByIdModification($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(OauthAuthCodePeer::DEFAULT_STRING_FORMAT);
    }
