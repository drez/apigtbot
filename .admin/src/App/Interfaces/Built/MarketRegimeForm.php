 ...
 *
 *  @version 1.1
 *  Generated Form class on the 'MarketRegime' table.
 *
 */
...
class MarketRegimeForm extends MarketRegime
{
    ...
    **/
    ...
    function __construct(Request|array|null $request, array $args)
    {
        ...
        $this->args = $args;
        $this->model_name = 'MarketRegime';
        $this->virtualClassName = 'MarketRegime';
...
. $actionCell
                , '', " 
                        ...
                        id='MarketRegimeRow".$__pkEsc."'")
                ;
                $gcDtRowHtml = tr(
                td(span(htmlspecialchars((string)((($altValue['Symbol'] !== null ) ? $altValue['Symbol'] : $data->getSymbol())))." "), "  i='" . $__pkJsonEsc . "' c='Symbol' class=''  j='editMarketRegime'") .
                td(span(htmlspecialchars((string)((($altValue['Tf'] !== null ) ? $altValue['Tf'] : $data->getTf())))." "), "  i='" . $__pkJsonEsc . "' c='Tf' class=''  j='editMarketRegime'") .
                td(span(htmlspecialchars((string)((($altValue['Price'] !== null ) ? $altValue['Price'] : str_replace(',', '.', (string)($data->getPrice() ?? '')))))." "), "  i='" . $__pkJsonEsc . "' c='Price' class='right'  j='editMarketRegime'") .
                td(span(htmlspecialchars((string)((($altValue['Trend'] !== null ) ? $altValue['Trend'] : isntPo($data->getTrend()))))." "), "  i='" . $__pkJsonEsc . "' c='Trend' class='center'  j='editMarketRegime'") .
                td(span(htmlspecialchars((string)((($altValue['Rsi14'] !== null ) ? $altValue['Rsi14'] : str_replace(',', '.', (string)($data->getRsi14() ?? '')))))." "), "  i='" . $__pkJsonEsc . "' c='Rsi14' class='right'  j='editMarketRegime'") .
                td(span(htmlspecialchars((string)((($altValue['AtrPct'] !== null ) ? $altValue['AtrPct'] : str_replace(',', '.', (string)($data->getAtrPct() ?? '')))))." "), "  i='" . $__pkJsonEsc . "' c='AtrPct' class='right'  j='editMarketRegime'") .
                td(span(htmlspecialchars((string)((($altValue['Adx14'] !== null ) ? $altValue['Adx14'] : str_replace(',', '.', (string)($data->getAdx14() ?? '')))))." "), "  i='" . $__pkJsonEsc . "' c='Adx14' class='right'  j='editMarketRegime'") .
            ...
            .div(
                div(
                    div(
                        ...
                        .span(_('Regime History'), " class='title' ")
                        ...
                        .(($_SESSION[_AUTH_VAR]->hasRights('MarketRegime', 'a') && !$this->setReadOnly) ? href("<i class='ri-add-line'></i>"._('New'), _SITE_URL.$this->virtualClassName."/edit/", " class='add-btn' ") : '')
                    ,''," class='va-mob-row1' ")
                    .div(
                ...
                .input('hidden', 'ip', $IdParent, "s='d'")
                 .div(
                     div(
                        div($tr, '', "id='MarketRegimeTable' class='va-mob-list'")
    ...
    */
    public function setCreateDefaultsMarketRegime(array $data): MarketRegime
    {

        unset($data['IdMarketRegime']);
        $e = new MarketRegime();
    ...
    *	Make sure default value are set before save
    */
    public function setUpdateDefaultsMarketRegime(array $data): ?MarketRegime
    {


        $e = $_SESSION[_AUTH_VAR]->loadPkScoped(MarketRegimeQuery::class, json_decode($data['i']), 'MarketRegime', 'w');
    ...
    /**
     * Produce a formated form of MarketRegime
    ...
    public function getEditForm($id, $uiTabsId = 'tabsContain', $data=[], $error=[], $jsElement='', $jsElementType=''): array
    {
        ...
        if($id && !$data['reload']) {
            ...
            if (!$_SESSION[_AUTH_VAR]->isRoot()) {
                ...
                $_SESSION[_AUTH_VAR]->applyOwnerGroupScope($q, $_SESSION[_AUTH_VAR]->hasRights('MarketRegime', 'r'));
            }
        ...
        if($dataObj == null){
            $this->MarketRegime['isNew'] = 'yes';
            $dataObj = new MarketRegime();
        }
...
$this->fields['MarketRegime']['Symbol']['html'] = stdFieldRow(_("Symbol"), input('text', 'Symbol', htmlentities((string)($dataObj->getSymbol() ?? '')), "   placeholder='".str_replace("'","&#39;",_('Symbol'))."' size='35'  v='SYMBOL' s='d' class='req'  ")."", 'Symbol', "", $this->commentsSymbol, $this->commentsSymbol_css, ' half', ' ', 'no', 'v2');
$this->fields['MarketRegime']['Tf']['html'] = stdFieldRow(_("Timeframe"), input('text', 'Tf', htmlentities((string)($dataObj->getTf() ?? '')), "   placeholder='".str_replace("'","&#39;",_('Timeframe'))."' size='15'  v='TF' s='d' class='req'  ")."", 'Tf', "", $this->commentsTf, $this->commentsTf_css, ' half', ' ', 'no', 'v2');
$this->fields['MarketRegime']['Price']['html'] = stdFieldRow(_("Price"), input('number', 'Price', $dataObj->getPrice(), "  placeholder='".str_replace("'","&#39;",_('Price'))."'  v='PRICE' size='10' s='d' class=''"), 'Price', "", $this->commentsPrice, $this->commentsPrice_css, ' half', ' ', 'no', 'v2');
$this->fields['MarketRegime']['Trend']['html'] = stdFieldRow(_("Trend"), selectboxCustomArray('Trend', [ '0' => ['0'=>_("strong_up"), '1'=>"strong_up"],'1' => ['0'=>_("up"), '1'=>"up"],'2' => ['0'=>_("sideways"), '1'=>"sideways"],'3' => ['0'=>_("down"), '1'=>"down"],'4' => ['0'=>_("strong_down"), '1'=>"strong_down"], ], _('Trend'), "s='d'  ", $dataObj->getTrend(), '', true), 'Trend', "", $this->commentsTrend, $this->commentsTrend_css, ' half', ' ', 'no', 'v2');
$this->fields['MarketRegime']['Rsi14']['html'] = stdFieldRow(_("RSI14"), input('number', 'Rsi14', $dataObj->getRsi14(), "  placeholder='".str_replace("'","&#39;",_('RSI14'))."'  v='RSI14' size='5' s='d' class=''"), 'Rsi14', "", $this->commentsRsi14, $this->commentsRsi14_css, ' half', ' ', 'no', 'v2');
$this->fields['MarketRegime']['AtrPct']['html'] = stdFieldRow(_("ATR %"), input('number', 'AtrPct', $dataObj->getAtrPct(), "  placeholder='".str_replace("'","&#39;",_('ATR %'))."'  v='ATR_PCT' size='5' s='d' class=''"), 'AtrPct', "", $this->commentsAtrPct, $this->commentsAtrPct_css, ' half', ' ', 'no', 'v2');
$this->fields['MarketRegime']['Adx14']['html'] = stdFieldRow(_("ADX14"), input('number', 'Adx14', $dataObj->getAdx14(), "  placeholder='".str_replace("'","&#39;",_('ADX14'))."'  v='ADX14' size='5' s='d' class=''"), 'Adx14', "", $this->commentsAdx14, $this->commentsAdx14_css, ' half', ' ', 'no', 'v2');
...
$this->fields['MarketRegime']['DepthImbalanceAvg']['html'] = stdFieldRow(_("Depth imbalance (smoothed)"), input('number', 'DepthImbalanceAvg', $dataObj->getDepthImbalanceAvg(), "  placeholder='".str_replace("'","&#39;",_('Depth imbalance (smoothed)'))."'  v='DEPTH_IMBALANCE_AVG' size='5' s='d' class=''"), 'DepthImbalanceAvg', "", $this->commentsDepthImbalanceAvg, $this->commentsDepthImbalanceAvg_css, ' half', ' ', 'no', 'v2');
        ...
        if(!$this->setReadOnly){
            ...
            if( ($_SESSION[_AUTH_VAR]->hasRights('MarketRegime','a') && !$id) || ($_SESSION[_AUTH_VAR]->hasRights('MarketRegime','w') && $id) ){
                $this->formSaveBtn = input('button', 'saveMarketRegime', _('Save'),' class="nav-save can-save"');
            }
            $this->formSaveBar = div( input('hidden', 'formChangedMarketRegime','', 'j="formChanged"')
                            .input('hidden', 'idPk', urlencode($id), "s='d'")
                        .input('hidden', 'IdMarketRegime', $dataObj->getIdMarketRegime(), " s='d' pk").input('hidden', 'IdGroupCreation', $dataObj->getIdGroupCreation(), " s='d' nodesc").input('hidden', 'IdCreation', $dataObj->getIdCreation(), " s='d' nodesc").input('hidden', 'IdModification', $dataObj->getIdModification(), " s='d' nodesc")
...
$this->fields['MarketRegime']['Symbol']['html']
.$this->fields['MarketRegime']['Tf']['html']
.$this->fields['MarketRegime']['Price']['html']
.$this->fields['MarketRegime']['Trend']['html']
.$this->fields['MarketRegime']['Rsi14']['html']
.$this->fields['MarketRegime']['AtrPct']['html']
.$this->fields['MarketRegime']['Adx14']['html']
...
.$this->fields['MarketRegime']['DepthImbalanceAvg']['html'] ."</div>",'',"class='form-card'")
                    ...
                    .$childPannelHtml
                ,"divCntMarketRegime", "class='sw-body form-scroll divStdform' CntTabs=1 ".$this->ccStdFormOptions)
                .$_gcFooterHtml
            ,'',"class='sw-drawer is-open proto-form'")
        , "id='formMarketRegime' class='mainForm formContent' ")
        .$this->hookFormBottom;
