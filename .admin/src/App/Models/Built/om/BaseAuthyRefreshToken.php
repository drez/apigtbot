...
/**
 * Base class that represents a row from the 'authy_refresh_token' table.
 *
 *
 *
 * @package    propel.generator..om
 */
abstract class BaseAuthyRefreshToken extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'App\\AuthyRefreshTokenPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        AuthyRefreshTokenPeer
     */
    ...
    /**
     * The value for the id_authy_refresh_token field.
     * @var        int
     */
    protected $id_authy_refresh_token;
    ...
    /**
     * The value for the token_hash field.
     * @var        string
     */
    ...
    /**
     * The value for the family_expires field.
     * @var        int
     */
    protected $family_expires;
    ...
    /**
     * Initializes internal state of BaseAuthyRefreshToken object.
     * @see        applyDefaults()
     */
    ...
    /**
     * @Field()
     * Get the [id_authy_refresh_token] column value.
     *
     * @return int
     */
    public function getIdAuthyRefreshToken()
    {

        return $this->id_authy_refresh_token;
    }
    ...
    /**
     * @Field()
     * Get the [token_hash] column value.
     *
     * @return string
     */
    ...
    /**
     * @Field()
     * Get the [family_expires] column value.
     *
     * @return int
     */
    public function getFamilyExpires()
    {

        return $this->family_expires;
    }
    ...
    public function getRevoked()
    {
        ...
        $valueSet = AuthyRefreshTokenPeer::getValueSet(AuthyRefreshTokenPeer::REVOKED);
    ...
    /**
     * Set the value of [id_authy_refresh_token] column.
     *
     * @param  int $v new value
     * @return AuthyRefreshToken The current object (for fluent API support)
     */
    public function setIdAuthyRefreshToken($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_authy_refresh_token !== $v) {
            $this->id_authy_refresh_token = $v;
            $this->modifiedColumns[] = AuthyRefreshTokenPeer::ID_AUTHY_REFRESH_TOKEN;
        }


        return $this;
    } // setIdAuthyRefreshToken()
    ...
    public function setIdAuthy($v)
    {
        ...
        if ($this->id_authy !== $v) {
            $this->id_authy = $v;
            $this->modifiedColumns[] = AuthyRefreshTokenPeer::ID_AUTHY;
        }
    ...
    public function setFamilyId($v)
    {
        ...
        if ($this->family_id !== $v) {
            $this->family_id = $v;
            $this->modifiedColumns[] = AuthyRefreshTokenPeer::FAMILY_ID;
        }
    ...
    /**
     * Set the value of [token_hash] column.
     *
     * @param  string $v new value
     * @return AuthyRefreshToken The current object (for fluent API support)
     */
    public function setTokenHash($v)
    {
        ...
        if ($this->token_hash !== $v) {
            $this->token_hash = $v;
            $this->modifiedColumns[] = AuthyRefreshTokenPeer::TOKEN_HASH;
        }
    ...
    public function setExpires($v)
    {
        ...
        if ($this->expires !== $v) {
            $this->expires = $v;
            $this->modifiedColumns[] = AuthyRefreshTokenPeer::EXPIRES;
        }
    ...
    /**
     * Set the value of [family_expires] column.
     *
     * @param  int $v new value
     * @return AuthyRefreshToken The current object (for fluent API support)
     */
    public function setFamilyExpires($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->family_expires !== $v) {
            $this->family_expires = $v;
            $this->modifiedColumns[] = AuthyRefreshTokenPeer::FAMILY_EXPIRES;
        }
    ...
    public function setRevoked($v)
    {
        ...
        if ($this->revoked !== $v) {
            $this->revoked = $v;
            $this->modifiedColumns[] = AuthyRefreshTokenPeer::REVOKED;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AuthyRefreshTokenPeer::CREATED_AT;
            }
    ...
    public function setLastUsedAt($v)
    {
        ...
        if ($this->last_used_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AuthyRefreshTokenPeer::LAST_USED_AT;
            }
        } // if either are not null
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AuthyRefreshTokenPeer::DATE_CREATION;
            }
        } // if either are not null
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AuthyRefreshTokenPeer::DATE_MODIFICATION;
            }
        } // if either are not null
    ...
    public function setIdGroupCreation($v)
    {
        ...
        if ($this->id_group_creation !== $v) {
            ...
            $this->modifiedColumns[] = AuthyRefreshTokenPeer::ID_GROUP_CREATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = AuthyRefreshTokenPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = AuthyRefreshTokenPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_authy_refresh_token = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->id_authy = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->family_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->token_hash = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->expires = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->family_expires = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->revoked = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->created_at = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->last_used_at = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            ...
            return $startcol + 14; // 14 = AuthyRefreshTokenPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AuthyRefreshToken object", $e);
        }
    }
    ...
    public function reload($deep = false, ?PropelPDO $con = null)
    {
        ...
        $stmt = AuthyRefreshTokenPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(?PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AuthyRefreshTokenQuery::create()
    ...
    public function save(?PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                AuthyRefreshTokenPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = AuthyRefreshTokenPeer::ID_AUTHY_REFRESH_TOKEN;
        if (null !== $this->id_authy_refresh_token) {
        ...
        if ($this->isColumnModified(AuthyRefreshTokenPeer::ID_AUTHY_REFRESH_TOKEN)) {
            $modifiedColumns[':p' . $index++]  = '`id_authy_refresh_token`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::ID_AUTHY)) {
            $modifiedColumns[':p' . $index++]  = '`id_authy`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::FAMILY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`family_id`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::TOKEN_HASH)) {
            $modifiedColumns[':p' . $index++]  = '`token_hash`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::EXPIRES)) {
            $modifiedColumns[':p' . $index++]  = '`expires`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::FAMILY_EXPIRES)) {
            $modifiedColumns[':p' . $index++]  = '`family_expires`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::REVOKED)) {
            $modifiedColumns[':p' . $index++]  = '`revoked`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::LAST_USED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`last_used_at`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::ID_GROUP_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_group_creation`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(AuthyRefreshTokenPeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `authy_refresh_token` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_authy_refresh_token`':
                        $stmt->bindValue($identifier, $this->id_authy_refresh_token, PDO::PARAM_INT);
                        break;
                    case '`id_authy`':
                        $stmt->bindValue($identifier, $this->id_authy, PDO::PARAM_INT);
                        break;
                    case '`family_id`':
                        $stmt->bindValue($identifier, $this->family_id, PDO::PARAM_STR);
                        break;
                    case '`token_hash`':
                        $stmt->bindValue($identifier, $this->token_hash, PDO::PARAM_STR);
                        break;
                    case '`expires`':
                        $stmt->bindValue($identifier, $this->expires, PDO::PARAM_INT);
                        break;
                    case '`family_expires`':
                        $stmt->bindValue($identifier, $this->family_expires, PDO::PARAM_INT);
                        break;
                    case '`revoked`':
        ...
        $this->setIdAuthyRefreshToken($pk);
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AuthyRefreshTokenPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AuthyRefreshTokenPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AuthyRefreshToken'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AuthyRefreshToken'][$this->getPrimaryKey()] = true;
        $keys = AuthyRefreshTokenPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdAuthyRefreshToken(),
            $keys[1] => $this->getIdAuthy(),
            $keys[2] => $this->getFamilyId(),
            $keys[3] => $this->getTokenHash(),
            $keys[4] => $this->getExpires(),
            $keys[5] => $this->getFamilyExpires(),
            $keys[6] => $this->getRevoked(),
            $keys[7] => $this->getCreatedAt(),
            $keys[8] => $this->getLastUsedAt(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdAuthyRefreshToken($value);
                break;
            case 1:
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setTokenHash($value);
                break;
            case 4:
                $this->setExpires($value);
                break;
            case 5:
                $this->setFamilyExpires($value);
                break;
            case 6:
                $valueSet = AuthyRefreshTokenPeer::getValueSet(AuthyRefreshTokenPeer::REVOKED);
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdAuthyRefreshToken($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setIdAuthy($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setFamilyId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setTokenHash($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setExpires($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setFamilyExpires($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setRevoked($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setCreatedAt($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setLastUsedAt($arr[$keys[8]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AuthyRefreshTokenPeer::ID_AUTHY_REFRESH_TOKEN)) $criteria->add(AuthyRefreshTokenPeer::ID_AUTHY_REFRESH_TOKEN, $this->id_authy_refresh_token);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::ID_AUTHY)) $criteria->add(AuthyRefreshTokenPeer::ID_AUTHY, $this->id_authy);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::FAMILY_ID)) $criteria->add(AuthyRefreshTokenPeer::FAMILY_ID, $this->family_id);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::TOKEN_HASH)) $criteria->add(AuthyRefreshTokenPeer::TOKEN_HASH, $this->token_hash);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::EXPIRES)) $criteria->add(AuthyRefreshTokenPeer::EXPIRES, $this->expires);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::FAMILY_EXPIRES)) $criteria->add(AuthyRefreshTokenPeer::FAMILY_EXPIRES, $this->family_expires);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::REVOKED)) $criteria->add(AuthyRefreshTokenPeer::REVOKED, $this->revoked);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::CREATED_AT)) $criteria->add(AuthyRefreshTokenPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::LAST_USED_AT)) $criteria->add(AuthyRefreshTokenPeer::LAST_USED_AT, $this->last_used_at);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::DATE_CREATION)) $criteria->add(AuthyRefreshTokenPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::DATE_MODIFICATION)) $criteria->add(AuthyRefreshTokenPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::ID_GROUP_CREATION)) $criteria->add(AuthyRefreshTokenPeer::ID_GROUP_CREATION, $this->id_group_creation);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::ID_CREATION)) $criteria->add(AuthyRefreshTokenPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(AuthyRefreshTokenPeer::ID_MODIFICATION)) $criteria->add(AuthyRefreshTokenPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(AuthyRefreshTokenPeer::DATABASE_NAME);
        $criteria->add(AuthyRefreshTokenPeer::ID_AUTHY_REFRESH_TOKEN, $this->id_authy_refresh_token);
    ...
    {
        return $this->getIdAuthyRefreshToken();
    }

    /**
     * Generic method to set the primary key (id_authy_refresh_token column).
     *
    ...
    {
        $this->setIdAuthyRefreshToken($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdAuthyRefreshToken();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of AuthyRefreshToken (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTokenHash($this->getTokenHash());
        $copyObj->setExpires($this->getExpires());
        $copyObj->setFamilyExpires($this->getFamilyExpires());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdAuthyRefreshToken(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AuthyRefreshToken Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AuthyRefreshTokenPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AuthyRefreshTokenPeer();
        }
    ...
    public function setAuthyRelatedByIdAuthy(?Authy $v = null)
    {
        ...
        if ($v !== null) {
            $v->addAuthyRefreshTokenRelatedByIdAuthy($this);
        }
    ...
    public function getAuthyRelatedByIdAuthy(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdAuthy === null && ($this->id_authy !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAuthyRelatedByIdAuthy->addAuthyRefreshTokensRelatedByIdAuthy($this);
             */
        }
    ...
    public function getAuthyGroup(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyGroup === null && ($this->id_group_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyGroup->addAuthyRefreshTokens($this);
             */
        }
    ...
    public function setAuthyRelatedByIdCreation(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addAuthyRefreshTokenRelatedByIdCreation($this);
        }
    ...
    public function getAuthyRelatedByIdCreation(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdCreation === null && ($this->id_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdCreation->addAuthyRefreshTokensRelatedByIdCreation($this);
             */
        }
    ...
    public function setAuthyRelatedByIdModification(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addAuthyRefreshTokenRelatedByIdModification($this);
        }
    ...
    public function getAuthyRelatedByIdModification(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdModification === null && ($this->id_modification !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdModification->addAuthyRefreshTokensRelatedByIdModification($this);
             */
        }
    ...
    {
        $this->id_authy_refresh_token = null;
        $this->id_authy = null;
        $this->family_id = null;
        $this->token_hash = null;
        $this->expires = null;
        $this->family_expires = null;
        $this->revoked = null;
    ...
    {
        return (string) $this->exportTo(AuthyRefreshTokenPeer::DEFAULT_STRING_FORMAT);
    }
