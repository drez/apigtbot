...
/**
 * Base class that represents a row from the 'oauth_client' table.
 *
 *
 *
 * @package    propel.generator..om
 */
abstract class BaseOauthClient extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'App\\OauthClientPeer';
    ...
    /**
     * The value for the client_secret_hash field.
     * @var        string
     */
    protected $client_secret_hash;
    ...
    /**
     * The value for the redirect_uris field.
     * @var        string
     */
    ...
    {
        $this->is_confidential = 0;
    }

    /**
     * Initializes internal state of BaseOauthClient object.
     * @see        applyDefaults()
     */
    ...
    /**
     * @Field()
     * Get the [client_secret_hash] column value.
     *
     * @return string
     */
    ...
    /**
     * @Field()
     * Get the [redirect_uris] column value.
     *
     * @return string
     */
    ...
    {
        if (null === $this->is_confidential) {
            return null;
        }
        $valueSet = OauthClientPeer::getValueSet(OauthClientPeer::IS_CONFIDENTIAL);
        if (!isset($valueSet[$this->is_confidential])) {
            throw new PropelException('Unknown stored enum key: ' . $this->is_confidential);
        }

        return $valueSet[$this->is_confidential];
    }
     ...
     * @return OauthClient The current object (for fluent API support)
     */
    public function setIdOauthClient($v)
    {
        ...
        if ($this->id_oauth_client !== $v) {
            $this->id_oauth_client = $v;
            $this->modifiedColumns[] = OauthClientPeer::ID_OAUTH_CLIENT;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[] = OauthClientPeer::CLIENT_ID;
        }
    ...
    /**
     * Set the value of [client_secret_hash] column.
     *
     * @param  string $v new value
     * @return OauthClient The current object (for fluent API support)
     */
    public function setClientSecretHash($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->client_secret_hash !== $v) {
            $this->client_secret_hash = $v;
            $this->modifiedColumns[] = OauthClientPeer::CLIENT_SECRET_HASH;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = OauthClientPeer::NAME;
        }
    ...
    /**
     * Set the value of [redirect_uris] column.
     *
     * @param  string $v new value
     * @return OauthClient The current object (for fluent API support)
     */
    public function setRedirectUris($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->redirect_uris !== $v) {
            $this->redirect_uris = $v;
            $this->modifiedColumns[] = OauthClientPeer::REDIRECT_URIS;
        }
    ...
    public function setGrantTypes($v)
    {
        ...
        if ($this->grant_types !== $v) {
            $this->grant_types = $v;
            $this->modifiedColumns[] = OauthClientPeer::GRANT_TYPES;
        }
    ...
    public function setScopes($v)
    {
        ...
        if ($this->scopes !== $v) {
            $this->scopes = $v;
            $this->modifiedColumns[] = OauthClientPeer::SCOPES;
        }
    ...
    public function setIsConfidential($v)
    {
        ...
        if ($this->is_confidential !== $v) {
            ...
            $this->modifiedColumns[] = OauthClientPeer::IS_CONFIDENTIAL;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OauthClientPeer::CREATED_AT;
            }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OauthClientPeer::DATE_CREATION;
            }
        } // if either are not null
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OauthClientPeer::DATE_MODIFICATION;
            }
        } // if either are not null
    ...
    public function setIdGroupCreation($v)
    {
        ...
        if ($this->id_group_creation !== $v) {
            ...
            $this->modifiedColumns[] = OauthClientPeer::ID_GROUP_CREATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = OauthClientPeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = OauthClientPeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_oauth_client = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->client_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->client_secret_hash = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->name = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->redirect_uris = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->grant_types = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->scopes = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->is_confidential = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            ...
            return $startcol + 14; // 14 = OauthClientPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating OauthClient object", $e);
        }
    }
    ...
    public function reload($deep = false, ?PropelPDO $con = null)
    {
        ...
        $stmt = OauthClientPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(?PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OauthClientQuery::create()
    ...
    public function save(?PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                OauthClientPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OauthClientPeer::ID_OAUTH_CLIENT)) {
            $modifiedColumns[':p' . $index++]  = '`id_oauth_client`';
        }
        if ($this->isColumnModified(OauthClientPeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`client_id`';
        }
        if ($this->isColumnModified(OauthClientPeer::CLIENT_SECRET_HASH)) {
            $modifiedColumns[':p' . $index++]  = '`client_secret_hash`';
        }
        if ($this->isColumnModified(OauthClientPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(OauthClientPeer::REDIRECT_URIS)) {
            $modifiedColumns[':p' . $index++]  = '`redirect_uris`';
        }
        if ($this->isColumnModified(OauthClientPeer::GRANT_TYPES)) {
            $modifiedColumns[':p' . $index++]  = '`grant_types`';
        }
        if ($this->isColumnModified(OauthClientPeer::SCOPES)) {
            $modifiedColumns[':p' . $index++]  = '`scopes`';
        }
        if ($this->isColumnModified(OauthClientPeer::IS_CONFIDENTIAL)) {
            $modifiedColumns[':p' . $index++]  = '`is_confidential`';
        }
        if ($this->isColumnModified(OauthClientPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(OauthClientPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(OauthClientPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(OauthClientPeer::ID_GROUP_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_group_creation`';
        }
        if ($this->isColumnModified(OauthClientPeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(OauthClientPeer::ID_MODIFICATION)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`client_id`':
                        ...
                        break;
                    case '`client_secret_hash`':
                        $stmt->bindValue($identifier, $this->client_secret_hash, PDO::PARAM_STR);
                        break;
                    case '`name`':
                        $stmt->bindValue($identifier, $this->name, PDO::PARAM_STR);
                        break;
                    case '`redirect_uris`':
                        $stmt->bindValue($identifier, $this->redirect_uris, PDO::PARAM_STR);
                        break;
                    case '`grant_types`':
                    ...
                    case '`is_confidential`':
                        $stmt->bindValue($identifier, $this->is_confidential, PDO::PARAM_INT);
                        break;
                    case '`created_at`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OauthClientPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OauthClientPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OauthClient'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OauthClient'][$this->getPrimaryKey()] = true;
        $keys = OauthClientPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdOauthClient(),
            $keys[1] => $this->getClientId(),
            $keys[2] => $this->getClientSecretHash(),
            $keys[3] => $this->getName(),
            $keys[4] => $this->getRedirectUris(),
            $keys[5] => $this->getGrantTypes(),
            $keys[6] => $this->getScopes(),
            $keys[7] => $this->getIsConfidential(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setClientSecretHash($value);
                break;
            case 3:
                $this->setName($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdOauthClient($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setClientId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setClientSecretHash($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setName($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setRedirectUris($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setGrantTypes($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setScopes($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setIsConfidential($arr[$keys[7]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OauthClientPeer::ID_OAUTH_CLIENT)) $criteria->add(OauthClientPeer::ID_OAUTH_CLIENT, $this->id_oauth_client);
        if ($this->isColumnModified(OauthClientPeer::CLIENT_ID)) $criteria->add(OauthClientPeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(OauthClientPeer::CLIENT_SECRET_HASH)) $criteria->add(OauthClientPeer::CLIENT_SECRET_HASH, $this->client_secret_hash);
        if ($this->isColumnModified(OauthClientPeer::NAME)) $criteria->add(OauthClientPeer::NAME, $this->name);
        if ($this->isColumnModified(OauthClientPeer::REDIRECT_URIS)) $criteria->add(OauthClientPeer::REDIRECT_URIS, $this->redirect_uris);
        if ($this->isColumnModified(OauthClientPeer::GRANT_TYPES)) $criteria->add(OauthClientPeer::GRANT_TYPES, $this->grant_types);
        if ($this->isColumnModified(OauthClientPeer::SCOPES)) $criteria->add(OauthClientPeer::SCOPES, $this->scopes);
        if ($this->isColumnModified(OauthClientPeer::IS_CONFIDENTIAL)) $criteria->add(OauthClientPeer::IS_CONFIDENTIAL, $this->is_confidential);
        if ($this->isColumnModified(OauthClientPeer::CREATED_AT)) $criteria->add(OauthClientPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(OauthClientPeer::DATE_CREATION)) $criteria->add(OauthClientPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(OauthClientPeer::DATE_MODIFICATION)) $criteria->add(OauthClientPeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(OauthClientPeer::ID_GROUP_CREATION)) $criteria->add(OauthClientPeer::ID_GROUP_CREATION, $this->id_group_creation);
        if ($this->isColumnModified(OauthClientPeer::ID_CREATION)) $criteria->add(OauthClientPeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(OauthClientPeer::ID_MODIFICATION)) $criteria->add(OauthClientPeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(OauthClientPeer::DATABASE_NAME);
        $criteria->add(OauthClientPeer::ID_OAUTH_CLIENT, $this->id_oauth_client);
     ...
     * objects.
     *
     * @param object $copyObj An object of OauthClient (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setClientSecretHash($this->getClientSecretHash());
        $copyObj->setName($this->getName());
        $copyObj->setRedirectUris($this->getRedirectUris());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OauthClient Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OauthClientPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OauthClientPeer();
        }
    ...
    public function getAuthyGroup(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyGroup === null && ($this->id_group_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAuthyGroup->addOauthClients($this);
             */
        }
    ...
    public function setAuthyRelatedByIdCreation(?Authy $v = null)
    {
        ...
        if ($v !== null) {
            $v->addOauthClientRelatedByIdCreation($this);
        }
    ...
    public function getAuthyRelatedByIdCreation(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdCreation === null && ($this->id_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdCreation->addOauthClientsRelatedByIdCreation($this);
             */
        }
    ...
    public function setAuthyRelatedByIdModification(?Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addOauthClientRelatedByIdModification($this);
        }
    ...
    public function getAuthyRelatedByIdModification(?PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdModification === null && ($this->id_modification !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdModification->addOauthClientsRelatedByIdModification($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(OauthClientPeer::DEFAULT_STRING_FORMAT);
    }
