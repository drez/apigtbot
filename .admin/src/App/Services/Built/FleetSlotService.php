...
class FleetSlotService
{
     ...
     * @var string
     */
    public $virtualClassName = 'FleetSlot';
    public $rawRequest;
    public $Form;
    public $contentType;
    public $headers;
    ...
    public function __construct($request, $response, $args )
    {
        ...
        // legacy
        $this->request = $args;
        $this->Form = new FleetSlotFormWrapper($request, $args);
    }
        ...
        switch($this->request['a']){
            ...
            case 'view':
                if ($this->request['a'] === 'edit' && empty($this->request['ui'])) {
                    ...
                    $this->content['onReadyJs'] .= "if(window.gcScreens){history.replaceState({gcEdit:null},'',_SITE_URL+'FleetSlot/');gcScreens.openEdit('FleetSlot'," . $gcEditPk . ");}";
                } else {
    ...
    */
    public function getApiResponse()
    {
        ...
        $Api = new Api('FleetSlot', $this, ['Symbol', 'Algo', 'TargetSlice', 'Enabled', 'State', 'ConfirmUp', 'ConfirmDown', 'LastVerdict', 'VerdictAt', 'EpisodeStartedAt', 'Activation', 'IdGridRun', 'LastEmptyAlertAt', 'LastParkedAlertAt']);
  ...
  array (
    ...
    public function deleteOne()
    {
        ...
        $obj = $_SESSION[_AUTH_VAR]->loadPkScoped(FleetSlotQuery::class, json_decode($this->request['i']), 'FleetSlot', 'd');
        if ($obj) {
    ...
    protected function gcDeleteRow($obj, &$error, &$messages)
    {
        ...
        try {
            ...
            error_log('FleetSlot delete refused by a foreign key: ' . $gcDelMsg);
    ...
    public function saveUpdate(): array
    {
        ...
        $data['i'] = ( $data['IdFleetSlot'] ) ? $data['IdFleetSlot'] : $this->request['i'];
        ...
        if(!empty($data['i'])) {
            ...
            $e = $this->Form->setUpdateDefaultsFleetSlot($data);
            if ($e === null) {
            ...
            $e = $this->Form->setCreateDefaultsFleetSlot($data);
