...
class MarketOutlookService
{
     ...
     * @var string
     */
    public $virtualClassName = 'MarketOutlook';
    public $rawRequest;
    public $Form;
    public $contentType;
    public $headers;
    ...
    public function __construct($request, $response, $args )
    {
        ...
        // legacy
        $this->request = $args;
        $this->Form = new MarketOutlookFormWrapper($request, $args);
    }
        ...
        switch($this->request['a']){
            ...
            case 'view':
                if ($this->request['a'] === 'edit' && empty($this->request['ui'])) {
                    ...
                    $this->content['onReadyJs'] .= "if(window.gcScreens){history.replaceState({gcEdit:null},'',_SITE_URL+'MarketOutlook/');gcScreens.openEdit('MarketOutlook'," . $gcEditPk . ");}";
                } else {
    ...
    */
    public function getApiResponse()
    {
        ...
        $Api = new Api('MarketOutlook', $this, ['Symbol', 'Kind', 'Verdict', 'PrevVerdict', 'PriceAt', 'CalledAt', 'Detail', 'EvalStatus', 'Price7d', 'Price30d', 'Ret7d', 'Ret30d', 'MaxAdversePct', 'Hit7d', 'Hit30d', 'ScoredAt']);
    ...
    public function deleteOne()
    {
        ...
        $obj = $_SESSION[_AUTH_VAR]->loadPkScoped(MarketOutlookQuery::class, json_decode($this->request['i']), 'MarketOutlook', 'd');
        if ($obj) {
    ...
    protected function gcDeleteRow($obj, &$error, &$messages)
    {
        ...
        try {
            ...
            error_log('MarketOutlook delete refused by a foreign key: ' . $gcDelMsg);
    ...
    public function saveUpdate(): array
    {
        ...
        $data['i'] = ( $data['IdMarketOutlook'] ) ? $data['IdMarketOutlook'] : $this->request['i'];
        ...
        if(!empty($data['i'])) {
            ...
            $e = $this->Form->setUpdateDefaultsMarketOutlook($data);
            if ($e === null) {
            ...
            $e = $this->Form->setCreateDefaultsMarketOutlook($data);
